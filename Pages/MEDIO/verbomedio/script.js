function salvarPontuacao() {
    localStorage.setItem('pontuacaoVerboMedio', pontos);
}

function zeraPontuacao() {
    localStorage.setItem('pontuacaoVerboMedio', 0);
}

function recuperarPontuacao() {
    return parseInt(localStorage.getItem('pontuacaoVerboMedio')) || 0;
}
...
function configurarBotoesNavegacao(indice) {
    ...
    voltarHomeButton.onclick = () => {
        window.location = "/Pages/index.html"; // URL para voltar à Home
    };
}
